...
int main(){
	...
	//Set up prompts	
	MessagePrompt<"system","The topic is the month of {topic}.\n The user instruction is: {input}"> systemMessage;
	...
	//Get user input
	cout<<"This will generate an type of output for every month of the year. Please provide an instruction, e.g. \"Write a poem\" or \"Give me suggestions for an international trip\" "<<endl;
	string userInput;
